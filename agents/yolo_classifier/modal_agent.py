...
"""
Medical Image Classifier Agent - 4 Classes
-----------------------------------------
Agent chuyên biệt cho việc phân loại hình ảnh nội soi dạ dày theo phương pháp nội soi
"""
...
@dataclass
class ModalClassifierClassConfig(BaseAgentConfig):
    """Cấu hình cho Classifier 4 lớp."""
    # Tham số model
...
class ModalClassifierClassAgent(BaseAgent):
    """
    Agent phân loại hình ảnh nội soi theo phương pháp nội soi.
    
    Phân loại phương pháp nội soi được sử dụng trong hình ảnh (BLI, FICE, LCI, WLI).
    """
    
    def __init__(self, config: ModalClassifierClassConfig):
        """
        ...
        # Thông tin bổ sung về các phương pháp nội soi
        self.class_descriptions = {
            "BLI": "Blue Laser Imaging - Kỹ thuật nội soi dùng ánh sáng xanh để tăng khả năng quan sát mạch máu",
            "FICE": "Flexible spectral Imaging Color Enhancement - Kỹ thuật tăng cường màu sắc phổ linh hoạt",
            "LCI": "Linked Color Imaging - Kỹ thuật nội soi tăng cường màu đỏ và trắng, phát hiện tổn thương sớm",
            "WLI": "White Light Imaging - Nội soi ánh sáng trắng thông thường"
        }
        ...
        self.logger.info(f"Classifier 4 lớp đã được khởi tạo với cấu hình: {self.classifier_config}")
    ...
    def _process_classification(self, image_path: Union[str, Image.Image], input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # Thêm thông tin kỹ thuật nội soi nếu có
